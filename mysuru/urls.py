...
urlpatterns = [
    ...
    path("stoch_weekly/load_eligible_futures/", views.load_eligible_futures_stoch_weekly_page, name="load_eligible_futures_stoch_weekly_page"),
    ...
    path("stoch_hourly/schedule_futures/", views.load_schedule_futures_stoch_weekly_page, name="load_schedule_futures_stoch_weekly_page"),
]
