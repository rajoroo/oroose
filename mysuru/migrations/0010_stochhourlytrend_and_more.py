    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "ha_cross_yesterday",
                    models.BooleanField(default=False, verbose_name="Heikin-Ashi Crossed Yesterday"),
                ),
                ("ha_cross", models.BooleanField(default=False, verbose_name="Heikin-Ashi Crossed Yesterday")),
                (
                    "ha_wma_cross_yesterday",
                    models.BooleanField(default=False, verbose_name="Heikin-Ashi WMA Crossed Yesterday"),
                ),
        ...
        migrations.AddConstraint(
            ...
            constraint=models.UniqueConstraint(
                fields=("date", "symbol"), name="mysuru_stochhourlytrend_unique_stoch_trend"
            ),
        ),
    ]
