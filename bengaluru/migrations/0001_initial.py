# Generated by Django 4.0.7 on 2022-10-28 03:50
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('stop_loss_id', models.CharField(blank=True, max_length=100, null=True, verbose_name='Stop Loss ID')),
                ...
                ('stop_loss_price', models.FloatField(default=0.0, verbose_name='Buy Price')),
        ...
        migrations.AddConstraint(
            ...
            constraint=models.UniqueConstraint(fields=('date', 'symbol'), name='bengaluru_fivehundred_unique_five_hundred'),
        ),
        migrations.AddField(
            model_name='fhzero',
            name='five_hundred',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='bengaluru.fivehundred', verbose_name='Five Hundred'),
        ),
    ]
