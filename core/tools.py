...
def get_ema(df):
    ...
    if len(df.index) > 7:
        return {
            "ema_200_0": round(df.iloc[-1]["ema_200"], 2),
            "ema_50_0": round(df.iloc[-1]["ema_50"], 2),
            "ema_20_0": round(df.iloc[-1]["ema_20"], 2),
            "ema_200_percentage_0": round(df.iloc[-1]["ema_200_percentage"], 2),
            "ema_200_1": round(df.iloc[-2]["ema_200"], 2),
            "ema_50_1": round(df.iloc[-2]["ema_50"], 2),
            "ema_20_1": round(df.iloc[-2]["ema_20"], 2),
            "ema_200_percentage_1": round(df.iloc[-2]["ema_200_percentage"], 2),
            "ema_200_2": round(df.iloc[-3]["ema_200"], 2),
            "ema_50_2": round(df.iloc[-3]["ema_50"], 2),
            "ema_20_2": round(df.iloc[-3]["ema_20"], 2),
            "ema_200_percentage_2": round(df.iloc[-3]["ema_200_percentage"], 2),
            "ema_200_3": round(df.iloc[-4]["ema_200"], 2),
            "ema_50_3": round(df.iloc[-4]["ema_50"], 2),
            "ema_20_3": round(df.iloc[-4]["ema_20"], 2),
            "ema_200_percentage_3": round(df.iloc[-4]["ema_200_percentage"], 2),
            "ema_200_4": round(df.iloc[-5]["ema_200"], 2),
            "ema_50_4": round(df.iloc[-5]["ema_50"], 2),
            "ema_20_4": round(df.iloc[-5]["ema_20"], 2),
            "ema_200_percentage_4": round(df.iloc[-5]["ema_200_percentage"], 2),
            "ema_200_5": round(df.iloc[-6]["ema_200"], 2),
            "ema_50_5": round(df.iloc[-6]["ema_50"], 2),
            "ema_20_5": round(df.iloc[-6]["ema_20"], 2),
            "ema_200_percentage_5": round(df.iloc[-6]["ema_200_percentage"], 2),
        }
    return {
        "ema_200_0": 0,
        "ema_50_0": 0,
        "ema_20_0": 0,
        "ema_200_percentage_0": 0,
        "ema_200_1": 0,
        "ema_50_1": 0,
        "ema_20_1": 0,
        "ema_200_percentage_1": 0,
        "ema_200_2": 0,
        "ema_50_2": 0,
        "ema_20_2": 0,
        "ema_200_percentage_2": 0,
        "ema_200_3": 0,
        "ema_50_3": 0,
        "ema_20_3": 0,
        "ema_200_percentage_3": 0,
        "ema_200_4": 0,
        "ema_50_4": 0,
        "ema_20_4": 0,
        "ema_200_percentage_4": 0,
        "ema_200_5": 0,
        "ema_50_5": 0,
        "ema_20_5": 0,
        "ema_200_percentage_5": 0,
    }
...
def get_heikin_ashi(df):
    if len(df.index) > 7:
        return {
            "ha_open_0": round(df.iloc[-1]["open"], 2),
            "ha_high_0": round(df.iloc[-1]["high"], 2),
            "ha_low_0": round(df.iloc[-1]["low"], 2),
            "ha_close_0": round(df.iloc[-1]["close"], 2),
            "ha_open_1": round(df.iloc[-2]["open"], 2),
            "ha_high_1": round(df.iloc[-2]["high"], 2),
            "ha_low_1": round(df.iloc[-2]["low"], 2),
            "ha_close_1": round(df.iloc[-2]["close"], 2),
            "ha_open_2": round(df.iloc[-3]["open"], 2),
            "ha_high_2": round(df.iloc[-3]["high"], 2),
            "ha_low_2": round(df.iloc[-3]["low"], 2),
            "ha_close_2": round(df.iloc[-3]["close"], 2),
            "ha_open_3": round(df.iloc[-4]["open"], 2),
            "ha_high_3": round(df.iloc[-4]["high"], 2),
            "ha_low_3": round(df.iloc[-4]["low"], 2),
            "ha_close_3": round(df.iloc[-4]["close"], 2),
            "ha_open_4": round(df.iloc[-5]["open"], 2),
            "ha_high_4": round(df.iloc[-5]["high"], 2),
            "ha_low_4": round(df.iloc[-5]["low"], 2),
            "ha_close_4": round(df.iloc[-5]["close"], 2),
            "ha_open_5": round(df.iloc[-6]["open"], 2),
            "ha_high_5": round(df.iloc[-6]["high"], 2),
            "ha_low_5": round(df.iloc[-6]["low"], 2),
            "ha_close_5": round(df.iloc[-6]["close"], 2),
        }
